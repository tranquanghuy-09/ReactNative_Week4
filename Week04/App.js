  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Tiki_oke">
        <Stack.Screen name="Login" component={Login2_a_Screen} />
        <Stack.Screen name="Screen_2_b" component={Screen_2_b} />
        <Stack.Screen name="PasswordGenerate" component={PasswordGenerateScreen} />
        <Stack.Screen name="Tiki_oke" component={Tiki_oke_Screen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}